...
export default function Home({ programmes }) {
  ...
  return (
    ...
    <div className="bg-dark text-light d-flex align-items-center justify-content-center " style={{height: "350px", margin: "100px 0"}}>
      <p className="display-3 text-center">Avancer à son ryhtme <i className="bi bi-activity text-light"></i></p>
    </div>
    {/*  */}
      ...
      <div className="row row-cols-1 row-cols-md-2">
        ...
        <div className="col" style={{lineHeight: "40px", textAlign: "justify"}}>
          ...
          <div className='d-flex justify-content-center mt-2'>
            <Link to="/e-coaching" ><button className='btn btn-dark px-4 py-3 shadow'>Découvrir <i className='bi bi-caret-right'></i></button></Link>
          </div>
        </div>
      </div>
    </div>
    {/* ligne de séparation */}
    <div className="bg-dark text-light d-flex align-items-center justify-content-center " style={{height: "350px", margin: "100px 0"}}>
      <p className="display-3 text-center">Des formules adaptées à votre budget <i className="bi bi-piggy-bank text-light"></i></p>
    </div>
    {/*  */}
      ...
      <div className='row row-cols-1 row-cols-md-2'>
          ...
          <div className='card'>
            ...
            <div className='card-body'>
              ...
              <div className='d-flex justify-content-center'>
                <Link to="/personal_training"><button className='btn btn-dark py-3 px-4 shadow'>Découvrir <i className='bi bi-caret-right'></i></button></Link>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className='card'>
            ...
            <div className='card-body'>
              ...
              <div className='d-flex justify-content-center'>
                <Link to="/e-coaching"><button className='btn btn-dark py-3 px-4 shadow'>Découvrir <i className='bi bi-caret-right'></i></button></Link>
              </div>
            </div>
          </div>
        </div>
    ...
    {/* ligne separation */}
      <div className="bg-dark text-light d-flex align-items-center justify-content-center " style={{height: "350px", margin: "100px 0"}}>
      <p className="display-3 text-center">Des repas sur mesures <i class="fa-solid fa-bowl-food"></i></p>
    </div>
    {/*  */}
    <div className='container' style={{marginBottom: "100px"}}>
      <div className='row row-cols-1 row-cols-md-2'>
        ...
        <div className='col'>
          ...
          <div className='d-flex justify-content-center'>
            <Link to="/dietetique"><button className='btn btn-dark py-3 px-4 mb-3 shadow'>Découvrir <i className='bi bi-caret-right'></i></button></Link>
          </div>
        </div>
        {/* 2 eme colonne */}
        <div className='col'>
